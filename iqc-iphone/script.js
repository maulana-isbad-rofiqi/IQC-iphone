...
function downloadImage() {
    ...
    // Capture only the active screen content (without phone frame)
    const activeView = state.mode === 'lockscreen'
        ? document.getElementById('view-lockscreen')
        : document.getElementById('view-whatsapp');
